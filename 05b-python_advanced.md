...
```
There are 45 degrees total and nine distinct types. Frequencies below:
PhD  31
ScD   5
MPH   2
MD    1
...
```
There are 37 titles total and three distinct types. Frequencies below:
...
```
There are 4 unique domains and the list of them is below:
...
```
 ...
 {('Pamela Ann', 'Shaw'): [' PhD', 'Assistant Professor', 'shawp@upenn.edu'], ('Kathleen Joy', 'Propert'): ['
Sc.D.', 'Professor', 'propert@mail.med.upenn.edu'], ('J. Richard', 'Landis'): [' B.S.Ed. M.S. Ph.D.', 'Professor', 'jrlandis@mail.med.up
enn.edu'], 
